...
namespace SpecFlow_BrowserStack
{
  ...
  public class BrowserStackDriver
  {
    ...
    public IWebDriver Init(string profile, string environment)
    {
      ...
      //File.AppendAllText("\\Mac\\Home\\Downloads\\specflow-browserstack-master\\SpecFlow-BrowserStack\\sf.log", "Starting local");
      ...
      //File.AppendAllText("\\Mac\\Home\\Downloads\\specflow-browserstack-master\\SpecFlow-BrowserStack\\sf.log", "Starting driver");
